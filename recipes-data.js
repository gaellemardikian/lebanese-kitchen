const RECIPES = [
  ...
  },
  {
    ...
    difficulty: "medium",
    image: "🥘",
    description: "Baked tray kibbeh — two layers of bulgur-meat shell sandwiching a spiced filling of beef and pine nuts, sliced into diamonds.",
    ingredients: [
      { item: "ground lamb", amount: "700g (or beef), divided" },
      { item: "fine bulgur", amount: "1 cup (#1 grade)" },
      { item: "onion", amount: "1 large, divided" },
      { item: "pine nuts", amount: "4 tbsp" },
      { item: "allspice", amount: "1½ tsp" },
      { item: "cinnamon", amount: "½ tsp" },
      { item: "cumin", amount: "½ tsp" },
      { item: "black pepper", amount: "½ tsp" },
      { item: "salt", amount: "1½ tsp" },
      { item: "olive oil", amount: "3 tbsp" },
      { item: "butter", amount: "2 tbsp, melted" },
      { item: "water", amount: "ice cold, as needed" }
    ],
    steps: [
      "Soak bulgur in cold water 20 min. Drain and squeeze very dry in a towel.",
      "Make shell dough: blend 500g lamb, bulgur, half the onion, 1 tsp allspice, cumin, salt, and a splash of ice water until a smooth, pliable dough forms. Chill 15 min.",
      "Make filling: dice remaining onion finely. Sauté in olive oil until golden. Add pine nuts, toast 2 min. Add 200g lamb, remaining allspice, cinnamon, pepper, salt — cook until meat is dry. Cool.",
      "Oil a 30cm round or rectangular baking tray generously.",
      "Wet hands. Press HALF the shell dough as a thin, even layer (about 1cm) covering the entire tray bottom.",
      "Spread the cooled meat filling evenly over the bottom layer.",
      "Press remaining shell dough into thin patties in your hands, lay them over the filling, and smooth into a second even layer. Dip fingers in cold water to seal edges and smooth the top.",
      "Score the top layer diagonally into diamond shapes with a knife. Press a pine nut into the center of each diamond if desired. Drizzle with melted butter.",
      "Bake at 200°C (400°F) for 35-40 min until deep golden brown on top.",
      "Rest 10 min. Serve with plain yogurt and a fresh salad."
    ],
    tags: ["kibbeh", "lamb", "baked", "bulgur", "festive"]
  },
  {
    id: 17,
    name: "Samke Harra",
...
// Wikipedia article titles used to fetch real dish photos
const WIKI_TITLES = {
  1:  "Hummus",
  2:  "Baba ganoush",
  3:  "Tabbouleh",
